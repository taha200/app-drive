export const Messages = {
  ...
  passwordValidationString:
    "Password should be 6-12 char alphanumeric, upercase and lowercase.",
  phoneValidationString: "Phone number should be at least 10 characters",
